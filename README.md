# Jet OpenAPI Specification
[![Build Status](https://travis-ci.org/ystory/redoc.svg?branch=master)](https://travis-ci.org/ystory/redoc)
...
6. If you did everything correct, https://ystory.github.io/redoc/ will lead to your new docs
...
- Documentation(ReDoc): https://ystory.github.io/redoc/
- SwaggerUI: https://ystory.github.io/redoc/swagger-ui/
- Look full spec:
    + JSON https://ystory.github.io/redoc/swagger.json
    + YAML https://ystory.github.io/redoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://ystory.github.io/redoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ystory.github.io/redoc/ with url from the message: `Server started <url>`
